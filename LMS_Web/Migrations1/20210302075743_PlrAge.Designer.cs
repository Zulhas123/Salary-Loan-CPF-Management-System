...
namespace LMS_Web.Migrations
{
    ...
    [Migration("20210302075743_PlrAge")]
    partial class PlrAge
    {
            ...
            modelBuilder.Entity("LMS_Web.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            BirthDate = new DateTime(1991, 3, 2, 13, 57, 42, 941, DateTimeKind.Local).AddTicks(8004),
                            ConcurrencyStamp = "c00fcf43-bb53-4671-91cd-2fb94c70f1cb",
                            CreatedDateTime = new DateTime(2021, 3, 2, 13, 57, 42, 940, DateTimeKind.Local).AddTicks(6612),
                            DepartmentId = 1,
                            DesignationId = 1,
                            ...
                            Image = "1.jpg",
                            IsActive = true,
                            JoiningDate = new DateTime(2011, 3, 2, 13, 57, 42, 941, DateTimeKind.Local).AddTicks(9703),
                            LastName = "Mahmud",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            BirthDate = new DateTime(1991, 3, 2, 13, 57, 42, 942, DateTimeKind.Local).AddTicks(3334),
                            ConcurrencyStamp = "c00fcf43-bb53-4671-91cd-2fb94c70f1cb",
                            CreatedDateTime = new DateTime(2021, 3, 2, 13, 57, 42, 942, DateTimeKind.Local).AddTicks(3316),
                            DepartmentId = 1,
                            DesignationId = 1,
                            Email = "hmuzzal@mail.com",
                            EmailConfirmed = true,
                            ...
                            Image = "2.jpg",
                            IsActive = true,
                            JoiningDate = new DateTime(2011, 3, 2, 13, 57, 42, 942, DateTimeKind.Local).AddTicks(3365),
                            LastName = "Mahmud",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEIW60+N8AuqIonyaDD/ODWNY/GCLpkM2khiNDoTwsWZEtyg+iIjuAgGIej2cqvNiKA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            BirthDate = new DateTime(1991, 3, 2, 13, 57, 42, 942, DateTimeKind.Local).AddTicks(3433),
                            ConcurrencyStamp = "c00fcf43-bb53-4671-91cd-2fb94c70f1cb",
                            CreatedDateTime = new DateTime(2021, 3, 2, 13, 57, 42, 942, DateTimeKind.Local).AddTicks(3432),
                            DepartmentId = 1,
                            DesignationId = 1,
                            Email = "hmuzzal@mail.com",
                            EmailConfirmed = true,
                            ...
                            Image = "3.jpg",
                            IsActive = true,
                            JoiningDate = new DateTime(2011, 3, 2, 13, 57, 42, 942, DateTimeKind.Local).AddTicks(3435),
                            LastName = "Khan",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEIW60+N8AuqIonyaDD/ODWNY/GCLpkM2khiNDoTwsWZEtyg+iIjuAgGIej2cqvNiKA==",

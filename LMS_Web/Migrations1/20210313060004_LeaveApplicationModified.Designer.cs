...
namespace LMS_Web.Migrations
{
    ...
    [Migration("20210313060004_LeaveApplicationModified")]
    partial class LeaveApplicationModified
    {
            ...
            modelBuilder.Entity("LMS_Web.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            BirthDate = new DateTime(1991, 3, 13, 12, 0, 2, 824, DateTimeKind.Local).AddTicks(398),
                            ConcurrencyStamp = "c00fcf43-bb53-4671-91cd-2fb94c70f1cb",
                            CreatedDateTime = new DateTime(2021, 3, 13, 12, 0, 2, 821, DateTimeKind.Local).AddTicks(3315),
                            DepartmentId = 1,
                            DesignationId = 1,
                            ...
                            Image = "1.jpg",
                            IsActive = true,
                            JoiningDate = new DateTime(2011, 3, 13, 12, 0, 2, 824, DateTimeKind.Local).AddTicks(4161),
                            LastName = "Mahmud",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            BirthDate = new DateTime(1991, 3, 13, 12, 0, 2, 825, DateTimeKind.Local).AddTicks(2019),
                            ConcurrencyStamp = "c00fcf43-bb53-4671-91cd-2fb94c70f1cb",
                            CreatedDateTime = new DateTime(2021, 3, 13, 12, 0, 2, 825, DateTimeKind.Local).AddTicks(1978),
                            DepartmentId = 1,
                            DesignationId = 1,
                            Email = "hmuzzal@mail.com",
                            EmailConfirmed = true,
                            ...
                            Image = "2.jpg",
                            IsActive = true,
                            JoiningDate = new DateTime(2011, 3, 13, 12, 0, 2, 825, DateTimeKind.Local).AddTicks(2072),
                            LastName = "Mahmud",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEIW60+N8AuqIonyaDD/ODWNY/GCLpkM2khiNDoTwsWZEtyg+iIjuAgGIej2cqvNiKA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            BirthDate = new DateTime(1991, 3, 13, 12, 0, 2, 825, DateTimeKind.Local).AddTicks(2254),
                            ConcurrencyStamp = "c00fcf43-bb53-4671-91cd-2fb94c70f1cb",
                            CreatedDateTime = new DateTime(2021, 3, 13, 12, 0, 2, 825, DateTimeKind.Local).AddTicks(2251),
                            DepartmentId = 1,
                            DesignationId = 1,
                            Email = "hmuzzal@mail.com",
                            EmailConfirmed = true,
                            ...
                            Image = "3.jpg",
                            IsActive = true,
                            JoiningDate = new DateTime(2011, 3, 13, 12, 0, 2, 825, DateTimeKind.Local).AddTicks(2258),
                            LastName = "Khan",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEIW60+N8AuqIonyaDD/ODWNY/GCLpkM2khiNDoTwsWZEtyg+iIjuAgGIej2cqvNiKA==",

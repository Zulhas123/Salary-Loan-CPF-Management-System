...
{
    public class DynamicMenu : ViewComponent
    {
        private readonly UserManager<AppUser> _userManager;
        private readonly RoleManager<IdentityRole> _roleManager;
        private readonly ApplicationDbContext _db;
        public DynamicMenu(ApplicationDbContext db,UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        public List<DynamicMenuVm> GetMenuByRole(string areaName = "")
        {
            ...
            if (userId != null)
            {
                ...
                var data = (from sr in _db.RoleSubMenus
                            ...
                            where sr.RoleId == roleId.ToString() && sub.MainMenuId == m.Id && (sub.AreaName == null || sub.AreaName == areaName|| sub.AreaName == "Identity")
                            orderby m.Order
                ...
                foreach (var item in data)
                {
                    ...
                    model.SubMenuLists = (from rm in _db.RoleSubMenus
                                          ...
                                          where rm.RoleId == roleId && m.Id == item.MainMenuId && (sm.AreaName == null || sm.AreaName == areaName || sm.AreaName == "Identity")

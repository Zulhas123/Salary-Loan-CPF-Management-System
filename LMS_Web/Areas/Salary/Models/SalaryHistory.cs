...
namespace LMS_Web.Areas.Salary.Models
{
    public class SalaryHistory
    {
        ...
        public decimal SpecialBenifit { get; set; }
        //
        ...
        public string CarSecondInterestInstallment { get; set; }
        //
        ...
        public string NetInWord { get; set; }
        public string Remarks { get; set; }

        public string NetSalaryBangla { get; set; }

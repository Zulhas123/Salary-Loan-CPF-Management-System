...
namespace LMS_Web.Areas.CPF.Components
{
    public class DynamicMenuListCpf : ViewComponent
    {
        private readonly UserManager<AppUser> _userManager;
        private readonly RoleManager<IdentityRole> _roleManager;
        private readonly ApplicationDbContext _db;
        public DynamicMenuListCpf(ApplicationDbContext db,UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        public List<DynamicMenuVm> GetMenuByRole(string areaName = "")
        {
            ...
            if (userId != null)
            {
                ...
                var data = (from sr in _db.RoleSubMenus
                            ...
                            where sr.RoleId == roleId && sub.MainMenuId == m.Id && sub.AreaName == areaName
            ...
            var orderByData= dMList.OrderBy(c=>c.Order).ToList();
            return orderByData;
        }
    }
}
